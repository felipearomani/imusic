...
@Component
public class PopSelector implements PlaylistSelector {

    private static final Double LIMIT_TEMPERATURE_MIN = 15.0;
    private static final Double LIMIT_TEMPERATURE_MAX = 30.0;
